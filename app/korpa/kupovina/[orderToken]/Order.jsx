    ...
    <>
      ...
      <div className={`mt-20 grid grid-cols-2 gap-16 xl:grid-cols-3`}>
        <div className={`col-span-2 xl:col-span-2`}>
          ...
          <div
            className={`mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3`}
          >
            {items?.map(
              ({
                ...
                return (
                  <div
                    key={id}
                    className={`col-span-1 overflow-hidden rounded-[10px] border`}
                  >
                    <Link href={`/${slug}`}>
                      <Image
        ...
        <div className={`col-span-2 xl:col-span-1`}>
          ...
          <div
            className={`mt-10 flex flex-col gap-2 rounded-[10px] bg-lightGray p-2`}
          >
          ...
          <div
            className={`mt-5 flex flex-col gap-2 rounded-[10px] bg-lightGray p-2`}
          >
            <h3 className={`${className} text-base font-light`}>
              Prodavac:{" "}
