...
const Contact = ({ defaultMessage }) => {
  ...
  return (
    <Provider reCaptchaKey={process.env.CAPTCHAKEY}>
      ...
      <div
        className={`sectionPaddingX grid w-full grid-cols-3 gap-x-10 gap-y-10 bg-white pt-6 sm:pt-10 2xl:pt-14`}
      >
        ...
        <form
          ...
          className={`col-span-3 mx-auto w-full rounded-lg border lg:col-span-2`}
        >
            ...
            >
              <div className={`flex flex-col gap-2`}>
                <div className={`flex items-center gap-2`}>
                  ...
                  <label
                    ...
                    className="h-4.5 w-4.5 flex cursor-pointer items-center justify-center rounded-[3px] border border-black bg-white px-[2px] py-[1px] text-white peer-checked:text-gold"
                  >
              ...
              <div className={`max-lg:w-full`}>
                <button
                  ...
                  className={`mainButton !text-[14px]`}
                >
                  {loading ? (
                    <i
