      ...
      {data?.items?.length > 0 || data?.pages?.length > 0 ? (
        <>
          <div className="mx-auto w-full bg-white">
            <div
              className={`sectionPaddingX flex flex-col gap-10 max-xl:hidden ${data?.pagination?.total_pages > 1 ? "sectionPaddingY" : "sectionPaddingT"} '`}
            >
              ...
              <div className="flex w-full flex-col gap-10">
                <div
                  className={`grid grid-cols-2 gap-x-5 gap-y-10 2xl:grid-cols-4`}
                >
          ...
          <div className="mx-auto w-full bg-white">
            <div className={`sectionPaddingX pb-20 pt-10 xl:hidden`}>
              <div
