...
export const FileUploadInput = ({
  ...
  return (
    <div className={`col-span-full mb-3 ${className ? className : ""}`}>
      <div className="rounded-md border border-dashed border-gray-300 bg-lightGray p-4">
        <label
          htmlFor={id}
          className="flex cursor-pointer flex-col items-center justify-center text-[15px]"
        >
  ...
  return (
    <div className={`col-span-full mb-3 ${className ? className : ""}`}>
      <div className="flex items-center">
        <label htmlFor={name} className={`mr-2 text-[15px]`}>
          Rating
